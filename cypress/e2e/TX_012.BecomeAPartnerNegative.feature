Feature: Test "Become a Telnyx Partner" form with negative scenario where all fields are filled with incorrect data
    ...
    Scenario: Verify that "This field is required." message appears after clicking "Apply Now" button with empty fields, the "Become a Telnyx Partner" form is triggered after clicking the "Become a partner" button on the "Partnerships" page.
