Feature: Check that "Confirm email" page is loading after clicking "SIGN UP" button on Sign Up page with filling the correct data in the required fields, form opened via link from the "SMS API" page
